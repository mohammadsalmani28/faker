...
return [
    'maleName' => [
        'عباس', 'وحید', 'علی', 'علیرضا', 'شاهرخ', 'سجاد', 'شایان', 'حسام', 'مهدی', 'بهرام',
        'حسن', 'حمید', 'آبتین', 'آرتین', 'سالار', 'یاشار', 'زامیاد', 'ساسان', 'فرزام', 'فرزین',
        'بابک', 'آرمان', 'آریانا', 'بیژن', 'بهروز', 'جهان', 'تورج', 'بهشاد', 'جمشید', 'عرفان',
        'جاوید', 'داریوش', 'احمد', 'محمود', 'محمد', 'پژمان', 'مهرداد', 'مهرشاد', 'کورش', 'صمد',
        'اَرشیا', 'اَشکان', 'امیرعلی', 'آتیلا', 'آراد', 'آرتا', 'آرشام', 'آرمین', 'آریا', 'محمدحسین',
        'بَردیا', 'بِنیامین', 'بهداد', 'بهراد', 'بهزاد', 'پَرهام', 'پَیام', 'پارسا', 'پدرام', 'صادق',
        'پویا', 'پویان', 'حِسام', 'حِسان', 'رامتین', 'سامان', 'سپهر', 'سیاوش', 'شاهین', 'شهاب',
        'فؤاد', 'کیانوش', 'ماهان', 'مِهراد', 'نیما', 'نوید', 'هومن', 'یاشار', 'فرهاد', 'علی اصغر',
        'رهام', 'آرین', 'آیدین', 'ساسان', 'سهیل', 'امیرعلی', 'امیرعباس', 'امیرمحمد', 'امین', 'علی اکبر',
        'ابوالفضل', 'احسان', 'احمدرضا', 'احمدعلی', 'ارسطو', 'اصغر', 'اکبر', 'امجد', 'امیر', 'عماد',
        'ایمان', 'جعفر', 'حافظ', 'حامد', 'حسین', 'حمزه', 'حمید', 'حمیدرضا', 'رضا', 'عیسی',
    ],
    'femaleName' => [
        'لیلا', 'مریم', 'سحر', 'زهرا', 'ریحانه', 'منیر', 'عطیه', 'پروانه', 'ترانه', 'بهار',
        'شقایق', 'المیرا', 'شیما', 'مرجان', 'المیرا', 'مینا', 'شیما', 'شیرین', 'شهرزاد', 'ترانه',
        'میترا', 'مهسا', 'پونه', 'نگین', 'مرجان', 'نازنین', 'نیلوفر', 'نگار', 'یگانه', 'نگار',
        'بهنوش', 'هستی', 'سیما', 'سروناز', 'ستاره', 'ساناز', 'رؤیا', 'پگاه', 'ارغوان', 'پرستو',
        'اِلناز', 'الینا', 'آتنا', 'آرمیتا', 'آیناز', 'باران', 'بهار', 'بیتا', 'پارمیدا', 'پانته‌آ',
        'پانیذ', 'پرستو', 'پریا', 'پوپک', 'تَرلان', 'تَرنّم', 'حنا', 'دُرسا', 'دلارام', 'کیمیا',
        'ملیکا', 'رونیکا', 'رویا', 'ژاله', 'سارا', 'عسل', 'غَزل', 'فرانک', 'گلاره', 'گندم',
        'لیندا', 'مهشید', 'مونا', 'میترا', 'نگین', 'نورا', 'نیکا', 'نیکی', 'ورونیکا', 'ویشکا',
        'هلما', 'هیلدا', 'اسما', 'اشرف', 'انیس', 'پری سیما', 'ثریا', 'حدیث', 'حدیثه', 'حدیقه',
        'حلیمه', 'حنانه', 'خدیجه', 'سمیه', 'سعیده', 'کبرا', 'فاطمه', 'مهسا', 'فائزه', 'زینب',
        'راحله', 'رعنا', 'رقیه', 'رعنا', 'ریحانه', 'زهره', 'سعیده', 'شقایق', 'شهره', 'شیما',
    ],
    'lastName' => [
        'محمدی', 'حسینی', 'احمدی', 'رضایی', 'کریمی', 'موسوی', 'جعفری', 'صادقی', 'حیدری', 'مرادی',
        'ابراهیمی', 'رحیمی', 'هاشمی', 'قاسمی', 'صالحی', 'کاظمی', 'اکبری', 'امیری', 'عباسی', 'اسدی',
        'امینی', 'باقری', 'طاهری', 'نوری', 'علیزاده', 'محمودی', 'شریفی', 'سلطانی', 'نجفی', 'زارع',
        'یوسفی', 'زمانی', 'نظری', 'ملکی', 'قربانی', 'سلیمانی', 'رحمانی', 'غلامی', 'عزیزی', 'میرزایی',
        'حسنی', 'خسروی', 'اسماعیلی', 'مقدم', 'عابدی', 'بهرامی', 'کرمی', 'رستمی', 'نصیری', 'توکلی',
        'غفاری', 'خلیلی', 'جلالی', 'فتحی', 'سلیمی', 'انصاری', 'فراهانی', 'نوروزی', 'حبیبی', 'عظیمی',
        'شفیعی', 'زارعی', 'افشار', 'رمضانی', 'نادری', 'مهدوی', 'دهقان', 'دهقانی', 'رجبی', 'شمس',
        'بیات', 'یزدانی', 'راد', 'امامی', 'محسنی', 'اسلامی', 'علوی', 'عسگری', 'کیانی', 'رنجبر',
        'فلاح', 'عبدالهی', 'قنبری', 'رشیدی', 'لطفی', 'کمالی', 'عبدی', 'جمشیدی', 'رضوی', 'تهرانی',
        'امین', 'جوادی', 'بابایی', 'علیپور', 'طالبی', 'ترابی', 'اسکندری', 'مختاری', 'منصوری', 'حمیدی',
        'ناصری', 'شهبازی', 'نعمتی', 'شعبانی', 'ایرانی', 'جمالی', 'سعیدی', 'عسکری', 'حاتمی', 'پارسا',
        'صمدی', 'فرجی', 'کشاورز', 'زاهدی', 'قادری', 'فرهادی', 'سهرابی', 'شیرازی', 'خانی', 'اصغری',
        'صابری', 'مومنی', 'رضا', 'پناهی', 'آزاد', 'ایزدی', 'مرتضوی', 'حقیقی', 'تقوی', 'رحمتی',
        'گودرزی', 'آزادی', 'جلیلی', 'محمد', 'بختیاری', 'عرب', 'حسین زاده', 'عبادی', 'رسولی', 'مهرابی',
        'سالاری', 'شکری', 'اشرفی', 'بخشی', 'میر', 'مجیدی', 'ایمانی', 'رضوانی', 'شاکری', 'شجاعی',
        'کلانتری', 'براتی', 'امیدی', 'طهماسبی', 'رفیعی', 'اخوان', 'افشاری', 'فاطمی', 'فاظلی', 'تقی زاده',
        'ملک', 'مدنی', 'وکیلی', 'محمدزاده', 'آقایی', 'حاجی', 'کشانی', 'طباطبایی', 'داوودی', 'زندی',
        'شریف', 'سعادت', 'معصومی', 'بهمنی', 'افتخاری', 'افتخاری', 'بهشتی', 'خادمی', 'میری', 'احمدیان'
    ],
    'email' => [
    ...
    'state' => [
        "آذربایجان شرقی", "آذربایجان غربی", "اردبیل", "اصفهان", "البرز", "ایلام", "بوشهر", "تهران", "چهارمحال و بختیاری", "خراسان جنوبی",
        "خراسان رضوی", "خراسان شمالی", "خوزستان", "زنجان", "سمنان", "سیستان و بلوچستان", "فارس", "قزوین", "قم", "کردستان",
        "کرمان", "کرمانشاه", "کهگیلویه وبویراحمد", "گلستان", "گیلان", "لرستان", "مازندران", "مرکزی", "هرمزگان", "همدان",
        "یزد"
    ],
    'city' => [
        "سهند", "سیس", "دوزدوزان", "تیمورلو", "صوفیان", "سردرود", "هادیشهر", "هشترود", "زرنق", "ترکمانچای",
        "ورزقان", "تسوج", "زنوز", "ایلخچی", "شرفخانه", "مهربان", "مبارک شهر", "تیکمه داش", "باسمنج", "سیه رود",
        "میانه", "خمارلو", "خواجه", "بناب مرند", "قره آغاج", "وایقان", "مراغه", "ممقان", "خامنه", "خسروشاه",
        "لیلان", "نظرکهریزی", "اهر", "بخشایش", "آقکند", "جوان قلعه", "کلیبر", "مرند", "اسکو", "شندآباد",
        "شربیان", "گوگان", "بستان آباد", "تبریز", "جلفا", "اچاچی", "هریس", "یامچی", "خاروانا", "کوزه کنان",
        "خداجو(خراجو)", "آذرشهر", "شبستر", "سراب", "ملکان", "بناب", "هوراند", "کلوانق", "ترک", "عجب شیر",
        "آبش احمد", "نالوس", "ایواوغلی", "شاهین دژ", "گردکشانه", "باروق", "سیلوانه", "بازرگان", "نازک علیا", "ربط",
        "تکاب", "دیزج دیز", "سیمینه", "نوشین", "میاندوآب", "مرگنلر", "سلماس", "آواجیق", "قطور", "محمودآباد", "خوی",
        "نقده", "سرو", "خلیفان", "پلدشت", "میرآباد", "اشنویه", "زرآباد", "بوکان", "پیرانشهر", "چهاربرج", "قوشچی",
        "شوط", "ماکو",
        "سیه چشمه", "سردشت",
        "کشاورز",
        "فیرورق",
    ...
    'jobTitle' => [
        'برنامه نوسی', 'مدیر شبکه', 'مدیر آی تی', 'مسئول پشتیبانی', 'فروشنده', 'بازاریاب', 'طراح', 'مدیر', 'آشپز',
        'گرافیست', 'کارگردان', 'هنرپیشه', 'آرایشگر', 'خیاط', 'عکاس', 'ورزشکار', 'ساست مدار', 'پلیس', 'پرستار',
        'کارگر', 'انباردار', 'پیک موتوری', 'نامه رسان', 'فروشنده', 'صندوقدار', 'راننده', 'آشپز', 'نانوا', 'قصاب',
        'بنا', 'برقکار', 'لوله کش', 'توسعه دهنده برنامه', 'مدیر دیتابیس', 'استاد دانشگاه', 'معلم', 'پزشک', 'معلم',
    ],
    'mobile' => [
    ...
    'company' => [
        'اذرآنلاین', 'دیجیکالا', 'دیجی استایل', 'اسنپ', 'تپسی', 'ایرانسل', 'شاتل', 'پارس آنلاین', 'کافه بازار', 'رسپینا',
        'طرفه نگار', 'ایران تام', 'آیدانیتو', 'حامی سیستم شریف', 'اسنپ فود', 'متین', 'تحلیلگرامید', 'یکتانت', 'ایران رنتر', 'پردازش نگار راشین',
        'بانی مد', 'گلرنگ سیستم', 'هیچستان', 'ارکید فارمد', 'فالنیک', 'آریامدتور', 'دلتا', 'یارا', 'علی بابا', 'آسان تجارت پارسی',
        'جاست', 'دایو پارس', 'آپارات', 'برتینا', 'سحاب پرداز', 'هومینگ', 'اسنپ باکس', 'چارگون', 'میزگرد نرم افزار', 'کسب و کار نوین ایرانیان',
        'کیلید', 'ایپاسنس', 'زرین پال', 'فلایتیو', 'وسنی', 'رایان مبین ایرسا', 'نارین ایده پاسارگاد', 'فرست کوئست', 'اورتا', 'توسعه فناوری اطلاعات چیستا'
    ],
    'word' => [
        'حساس', 'ترافیک', 'فروش', 'سایت', 'ارگانیک', 'افزایش', 'نرخ', 'سئو', 'کاربردی', 'ابزار',
        'بهبود', 'تجربه', 'بهبود', 'فروشگاه', 'سرعت', 'جستجو', 'موتورهای جستجو', 'موبایل', 'آن ین', 'لینک',
        'حرفه', 'کلیک', 'مخاطب', 'صفحه', 'تصاویر', 'اشتراک', ' شبکه ها اجتماعی', 'محصول', ' آن ین', 'توسعه دهنده',
        'حرفه ای', 'فاکتور', 'بهینه سازی', 'ترافیک', 'پروتکل', 'امنیت', 'محتوا', 'دانلود', 'رایگان', 'استاندارد',
        'خرید', 'رتبه بندی', 'الگوریتم های گوگل', 'وب گردی', 'وب گ نوس', 'مخاطب', 'رپورتاژ خبری', 'مقایسه', ' اط عات', 'نقشه', 'برچسب',
        'بانک', 'چشمپوشی', 'اینترنت', 'پیامرسان', 'دولت', 'حمایت', 'هیولا', 'یادداشت', 'لینوکس', 'هوشمند',
        'عروسک', 'رباتیک', 'کودکان', 'کتاب', 'روزرسانی', 'وبمستر', 'آنالیتیکس', 'بازی', 'فوتبال', 'بلیت'
    ],
    'sentence' => [
...
به نمونههاي خارجی آن است.',
    ...
    'carModel' => [
        'پراید', 'پژو 206', 'پژو 405', 'برلیانس', 'پیکان',
        'وانت', 'نیسان', 'ال90', 'پرشیا', 'زانتیا', 'پژو پارس',
        'سمند', 'دنا', 'پیکان', 'تیبا', 'مازراتی', 'چانگان',
        'مزدا3', 'ماکسیما', 'ساینا',
    ],
    'Insurance' => [
        'آرمان', 'آسماری', 'آسیا', 'ایرانیان', 'اتکایی', 'البرز',
        'امید', 'ایران', 'ایران معین', 'پارسیان', 'پاسارگاد', 'تجارت نو',
        'تعاون', 'سرمد', 'رازی', 'خاورمیانه', 'سامان', 'نوین',
        'توسعه', 'حافظ', 'حکمت صبا', 'دانا', 'دی', 'میهن',
        'سینا', 'کارآفرین', 'کوثر', 'ما', 'معلم', 'ملت',
    ],
];
